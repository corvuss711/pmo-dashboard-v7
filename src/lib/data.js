...
const BASE_INITIATIVES = [
  { key: "parivartan", name: "PARIVARTAN", ministry: "MORTH", owner: "MoRTH · NCRPB",
    ...
    l1: [
      { seg: "trucks", name: "% of pre-BS VI vehicles converted (Trucks)", num: 0, den: 0,
      ...
      { seg: "buses", name: "% of pre-BS VI vehicles converted (Buses)", num: 0, den: 0,
    ...
    metrics: [
      ...
      { stage: 2, stageLabel: "Scrap vs sell", name: "% CoD generated by RVSF", num: 0, den: 0,
      ...
      { stage: 2, stageLabel: "Scrap vs sell", name: "% sell outside NCR process completed by RTO", num: 0, den: 0,
      ...
      { stage: 3, stageLabel: "Loan", name: "Share of loans approved", num: 0, den: 0,
      ...
      { stage: 3, stageLabel: "Loan", name: "Share of loans disbursed", num: 0, den: 0,
      ...
      { stage: 4, stageLabel: "Interest subvention", name: "% interest subvention approved by Nodal bank", num: 0, den: 0,
      ...
      { stage: 4, stageLabel: "Interest subvention", name: "% interest subvention disbursed by NCRPB", num: 0, den: 0,
      ...
      { stage: 5, stageLabel: "One-time claim (OTC)", name: "% one-time claims (OTC) disbursed by NCRPB", num: 0, den: 0,
      ...
      { stage: 6, stageLabel: "Fuel voucher", name: "% fuel voucher payments released by NCRPB", num: 0, den: 0,
  ...
  { key: "scc", name: "SCC setup and operations", ministry: "MOHUA", owner: "MoHUA · ULBs",
    ...
    l1: [{ name: "% SCCs operationalized", num: 0, den: 0,
    ...
    metrics: [
      { stage: 1, stageLabel: "Land identified", name: "% SCCs where land identified", num: 0, den: 0,
      ...
      { stage: 3, stageLabel: "SOP compliance", name: "% compliance with SOP", num: 0, den: 0,
      ...
      { stage: 4, stageLabel: "Intake", name: "Intake per SCC", num: 0, den: 0, rate: true, unit: " T",
  ...
  { key: "greening", name: "Greening", ministry: "MOHUA", owner: "MoEFCC · State forest depts.",
    ...
    metrics: [
      { stage: 1, stageLabel: "Plantation", name: "% plantation target achieved", num: 0, den: 0,
  ...
  { key: "cems", name: "CEMS and APCD for industries", ministry: "MOEFCC", owner: "MoEFCC · SPCB · NCRPB",
    ...
    l1: [
      { seg: "apcd", name: "% APCD installations completed", noCumulative: true, num: 327, den: 2115,
      ...
      { seg: "ocems", name: "% industries with no red alerts", noCumulative: true, num: 0, den: 0, noRangeScale: true,
    ...
    metrics: [
      ...
      { seg: "apcd", stage: 2, stageLabel: "Screening & approval", name: "% applications rejected", num: 203, den: 1149,
        ...
        glossary: "A lower figure is better here in practice, but the status band follows the same legend as every other metric." },
      ...
      { seg: "ocems", stage: 6, stageLabel: "OCEMS", name: "% industries with OCEMS installed", noCumulative: true, num: 0, den: 0, noRangeScale: true,
      ...
      { seg: "ocems", stage: 6, stageLabel: "OCEMS", name: "% industries with no red alerts where OCEMS is active", noCumulative: true, num: 0, den: 0, noRangeScale: true,
