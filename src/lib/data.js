...
export const INITIATIVES = [
  ...
  { key: "cems", name: "CEMS and APCD for industries", ministry: "MOEFCC", owner: "MoEFCC · SPCB · NCRPB",
    ...
    l1: [
      ...
      { seg: "ocems", name: "% industries with no red alerts", num: 0, den: 0, noRangeScale: true,
    ...
    metrics: [
      ...
      { seg: "ocems", stage: 6, stageLabel: "OCEMS", name: "% industries with OCEMS installed", num: 0, den: 0, noRangeScale: true,
